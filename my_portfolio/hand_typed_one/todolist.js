...
li.prepend(checkBox);
checkBoxArray=Array.from(document.querySelectorAll("input[type='checkbox']"));
console.log("checkBoxArray is..");
console.log(checkBoxArray);
    ...
    checkBox.addEventListener("change",(e)=>{
        ...
        localStorage.setItem("savedUncompletedList",JSON.stringify(uncompletedList));
        // let get_index= checkBoxArray.indexOf(checkBoxArray[index]);
        // console.log("get_index is.."+get_index);
        // uncompletedList[get_index].completed=uncompletedList[get_index].completed?false:true;
        // console.log(uncompletedList[get_index]);
